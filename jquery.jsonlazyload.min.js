// (c) 2015 Joe Ridino
(function($){'use strict';var JSONLazyLoad=function(element,options){var default_settings={behavior:{ensure_scrollbar:false,fetch_amount:10,fetch_immediate:true,initial_offset:0,loader_delay:100,scroll_threshold:1},files:{pattern:'',num_files:0},elements:{scroll_target:$(window),loader:null},results:{before_callback:null,fail_callback:null,item_callback:null,item_key:null},ws:{data_type:'json',limit_param:'limit',offset_param:'offset',url:''}},added_event_handlers=false,ajaxing=false,check_add_event_handlers,files_offset=0,has_scrollbar,init,jquery_element=$(element),loaded_all=false,loader_hide,loader_show,loader_timeout_id,offset=0,prev_scroll_top=0,promise=null,promise_always,promise_done,promise_fail,resize_check,scroll_check,self=this,settings=null,tear_down;this.target=function(){return jquery_element;};this.fetch_items=function(limit){if(ajaxing||loaded_all){return;}
